...
public class Driver
{
    ...
    {
        Street street = new Street(); // Creating street object
        ...
        street.getLeftSide()[1].focusing();
        street.getRightSide()[0].focusing();
        street.silhouette();
        ...
        //System.out.printf("\n\n\nSet length of your street: ");
        //street.setLength(input.nextInt());
